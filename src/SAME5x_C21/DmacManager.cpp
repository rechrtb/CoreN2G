...
alignas(16) __attribute__((section(".DmaBuffers"))) static DmacDescriptor descriptor_section[NumDmaChannelsSupported];

// Write back descriptors for all used DMAC channels
alignas(16) __attribute__((section(".DmaBuffers"))) static DmacDescriptor write_back_section[NumDmaChannelsSupported];
